...
const (
	maxConnAttempts     = 3 // increased from 1 to reduce aggressive pruning // when there is maxConnAttempts failed connect calls for a given peer it is considered non-connectable
